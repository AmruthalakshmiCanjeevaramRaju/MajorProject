...
auth_manager = SpotifyClientCredentials('Amruthacr','amrutha@2002')
...
def getTrackFeatures(id):
    ...
    track_data = [name, album, artist] #, release_date, lenrequirements.txtgth, popularity
    return track_data

# Code for creating dataframe of feteched playlist

emotion_dict = {0:"Angry",1:"Happy",2:"Sad",3:"Surprised"}
music_dist={0:"0l9dAmBrUJLylii66JOsHB?si=e1d97b8404e34343",1:"0deORnapZgrxFY4nsKr9JA?si=7a5aba992ea14c93",2:"1n6cpWo9ant4WguEo91KZh?si=617ea1c66ab6446b",3:"37i9dQZEVXbMDoHDwVN2tF?si=c09391805b6c4651"}
